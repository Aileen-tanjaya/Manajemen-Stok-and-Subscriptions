        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- INPUT PENCARIAN - VERSI FIX TOTAL --}}
                    ...
                    {{-- STATISTIK RINGKASAN - OTOMATIS & WARNA JELAS --}}
                        ...
                        <table class="w-full border-collapse bg-white">
                            <thead>
                                <tr class="bg-gray-100">
                                    ...
                                    <th class="border border-gray-200 px-4 py-2 text-left">Stok</th>
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-50 border-b border-gray-100 transition-colors">
                                    ...
                                    <td class="border border-gray-200 px-4 py-4">
                                        ...
                                        {{ $stok->satuan == 'gram' ? 'bg-green-50 text-green-700 border-green-200' : '' }}
                                        {{ $stok->satuan == 'pcs' ? 'bg-blue-50 text-blue-700 border-blue-200' : '' }}
                                        {{ $stok->satuan == 'ml' ? 'bg-cyan-50 text-cyan-700 border-cyan-200' : '' }}
                                        {{ $stok->satuan == 'pouch' ? 'bg-red-50 text-red-700 border-red-200' : '' }}
                                        {{ $stok->satuan == 'sisir' ? 'bg-purple-50 text-purple-700 border-purple-200' : '' }}">
                                            {{ $stok->satuan }}
                                        </span>
                                    </td>
                                    <td class="border border-gray-200 px-4 py-4 font-bold text-sm">
                                        {{ $stok->stok }}
                                    </td>
                                    <td class="border border-gray-200 px-4 py-4">
                                        @if($stok->stok <= 0)
                                    ...
                                    <td class="border border-gray-200 px-4 py-4 text-sm font-medium">
